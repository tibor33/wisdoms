...
# text file location
#wis_storage = '/sdcard/kivy/wisdoms.txt'
#wis_storage = '/tmp/kivy/wisdoms.txt'
...
#        wisdoms_list = open(wis_storage,'r')
...
#    implemented_list = open(wis_storage,'r')
...
#    will_try_list = open(wis_storage,'r')
...
class Wisdoms(App):
    def build(self):
#	shutil.copyfile('wisdoms.txt', wis_storage)
        return sm
